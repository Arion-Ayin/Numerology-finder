  ...
  Widget build(BuildContext context) {
    ...
    final List<DeveloperNote> notes = [
      ...
      DeveloperNote(
        ...
        contentKo: '''
안녕하세요 아리온 아인입니다.
이번 1.2.0+35 업데이트 사항입니다.

1. 행운숫자 추가
2. 절정수 & 도전수 추가
3. 대주기 추가
4. 연령진동수 추가 및 1년수 숫자 수정
...
This is a 1.2.0+35 update.

1. Add a lucky number
2. Add Choi Jong-soo & Challenge-soo
3. Add a period
4. Add age frequencies and modify the number of years
...
''',
        actions: [
          NoteAction(
            label:
                appLocalizations!.btnReview, // '리뷰 남기러 가기' / 'Leave a Review'
            url:
                          ...
                          child: Theme(
                            ...
                            child: ExpansionTile(
                              ...
                              backgroundColor: Theme.of(
                                context,
                              ).cardColor.withAlpha((0.8 * 255).toInt()),
                              title: Column(
          ...
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: Theme.of(
                  context,
                ).textTheme.bodySmall?.color?.withAlpha((0.5 * 255).toInt()),
              ),
            ),
          ),
        ],
